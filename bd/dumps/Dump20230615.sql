...
--
-- Host: localhost    Database: sysadocao
-- ------------------------------------------------------
...
CREATE TABLE `cidade` (
  ...
  CONSTRAINT `fk_Cidade_Estado` FOREIGN KEY (`Estado_id`) REFERENCES `mydb`.`estado` (`ID`)
...
INSERT INTO `cidade` VALUES (1,1,'São Paulo'),(2,1,'Campinas'),(3,2,'Rio de Janeiro'),(4,3,'Belo Horizonte');
...
INSERT INTO `estado` VALUES (1,'SP','São Paulo'),(2,'RJ','Rio de Janeiro'),(3,'MG','Minas Gerais');
...
-- Dump completed on 2023-06-15 22:11:20
