...
public class TelaBairro extends AbstractTela {
	
	private static final long serialVersionUID = 1L;
	
	BairroTableModel tableModel;
	JButton btnFechar;
	JButton btnExcluir;
	JButton btnAlterar;
	JButton btnInserir;
	...
	public TelaBairro(String header) {
	...
	public void montaBotoes() {
		...
		btnExcluir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					BairroDao.delete(Integer.parseInt(idStr));
					remontaTable();
	...
	public void abreTelaCadastro(Integer id) {
		TelaBairroCadastro telaCadastro = new TelaBairroCadastro(id, this);
	...
	public BairroTableModel getTableModel() {
		List<Bairro> bairros = new ArrayList<>();
		try {
			bairros = BairroDao.get();
		}catch(Exception e) {
			
		}
		
		tableModel = new BairroTableModel(bairros);
		return tableModel;
	}
