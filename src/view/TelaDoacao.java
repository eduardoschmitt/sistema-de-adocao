...
public class TelaDoacao extends AbstractTela{
	DoacaoTableModel tableModel;
	JButton btnFechar;
	JButton btnExcluir;
	JButton btnAlterar;
	JButton btnInserir;
	...
	public TelaDoacao(String header) {
	...
	public void montaBotoes() {
		...
		btnExcluir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					DoacaoDao.delete(Integer.parseInt(idStr));
					remontaTable();
	...
	public void abreTelaCadastro(Integer id) {
		TelaDoacaoCadastro telaCadastro = new TelaDoacaoCadastro(id, this);
	...
	public DoacaoTableModel getTableModel() {
		List<Doacao> doacoes = new ArrayList<>();
		try {
			doacoes = DoacaoDao.get();
		}catch(Exception e) {
			
		}
		
		DoacaoTableModel tableModel = new DoacaoTableModel(doacoes);
		return tableModel;
	}
