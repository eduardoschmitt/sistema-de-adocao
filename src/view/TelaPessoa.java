...
public class TelaPessoa extends AbstractTela {
	
	private static final long serialVersionUID = 1L;
	
	PessoaTableModel tableModel;
	JButton btnFechar;
	JButton btnExcluir;
	JButton btnAlterar;
	JButton btnInserir;
	...
	public TelaPessoa(String header) {
	...
	public void montaBotoes() {
		...
		btnExcluir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					PessoaDao.delete(Integer.parseInt(idStr));
					remontaTable();
	...
	public void abreTelaCadastro(Integer id) {
		TelaPessoaCadastro telaCadastro = new TelaPessoaCadastro(id, this);
